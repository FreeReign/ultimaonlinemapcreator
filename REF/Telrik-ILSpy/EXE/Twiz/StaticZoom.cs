	...
	public class StaticZoom : Form
	{
		...
		internal virtual Panel Panel2
		{
			...
			set
			{
				...
				{
					StaticZoom staticZoom = this;
					this._Panel2.MouseDown -= new MouseEventHandler(staticZoom.Panel2_MouseDown);
					StaticZoom staticZoom1 = this;
					this._Panel2.Paint -= new PaintEventHandler(staticZoom1.Panel2_Paint);
				}
				this._Panel2 = value;
				if (this._Panel2 != null)
				{
					StaticZoom staticZoom2 = this;
					this._Panel2.MouseDown += new MouseEventHandler(staticZoom2.Panel2_MouseDown);
					StaticZoom staticZoom3 = this;
					this._Panel2.Paint += new PaintEventHandler(staticZoom3.Panel2_Paint);
				}
			}
		}
		...
		internal virtual VScrollBar VScrollBar1
		{
			...
			set
			{
				...
				{
					StaticZoom staticZoom = this;
					this._VScrollBar1.Scroll -= new ScrollEventHandler(staticZoom.VScrollBar1_Scroll);
				}
				this._VScrollBar1 = value;
				if (this._VScrollBar1 != null)
				{
					StaticZoom staticZoom1 = this;
					this._VScrollBar1.Scroll += new ScrollEventHandler(staticZoom1.VScrollBar1_Scroll);
				}
			}
		}
		...
		private void InitializeComponent()
		{
			...
			point = new Point(336, 8);
			pictureBox1.Location = point;
			this.PictureBox1.Name = "PictureBox1";
			PictureBox pictureBox = this.PictureBox1;
			size = new System.Drawing.Size(200, 480);
			...
			size = new System.Drawing.Size(542, 491);
